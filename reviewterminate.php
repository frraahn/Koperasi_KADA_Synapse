...
<body>
    ...
    <div class="container">
        ...
        <div class="content-container">
            <form id="batchForm" method="POST" action="bulkReviewTerminateProcess.php">
            <button type="button" class="btn btn-success" onclick="bulkAction('approve', event)">Luluskan Pilihan</button>
            <button type="button" class="btn btn-danger" onclick="bulkAction('reject', event)">Tolak Pilihan</button>
            ...
            <table class="table">
                ...
                <tbody id="tableBody">
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td><a href='adreviewterminate.php?staffNo=" . urlencode($row['staffNo']) . "' class='text-decoration-none'>" . ($row['applicantName'] ?? 'N/A') . "</a></td>";
                        echo "<td>" . ($row['applyDate'] ?? 'N/A') . "</td>";
                        echo "<td>
                                <a href='reviewterminateprocess.php?staffNo=" . urlencode($row['staffNo']) . "&action=Lengkap' class='btn btn-success'>Lengkap</a>
                                <a href='reviewterminateprocess.php?staffNo=" . urlencode($row['staffNo']) . "&action=Tidak Lengkap' class='btn btn-danger'>Tidak Lengkap</a>
                              </td>";
    ...
    let selected = Array.from(document.querySelectorAll(".staffCheckbox:checked"))
    ...
    if (!adminStaffNo || adminStaffNo.trim() === "") {
        alert("Nombor Kakitangan Admin diperlukan!");
        return;
    }
    ...
    form.method = "POST";
    form.action = "bulkReviewTerminateProcess.php";
    ...
    addHiddenField("action", action);
    addHiddenField("adminStaffNo", adminStaffNo);
    if (action === 'reject') {
        addHiddenField("reason", reason);
    }

    selected.forEach(staffNo => addHiddenField("staffNos[]", staffNo));
