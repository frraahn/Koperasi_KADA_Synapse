...
<body>
  ...
  <div class="sidebar" id="sidebar">
    <ul><br>
      <li><a href="admin.php">Laman Utama</a></li>
      
      <li>
        <a class="dropdown-toggle">Semak Permohonan </a>
        <ul class="dropdown-menu">
          <li><a href="reviewMembershipList.php">Anggota</a></li>
          <li><a href="reviewLoanList.php">Pinjaman</a></li>
          <li><a class="dropdown-item" href="reviewterminate.php">Berhenti</a></li>
        </ul>
      </li>

      <li><a class="nav-link" href="sendstatus.php">Penghantaran Status</a></li>

      <li>
        <a class="dropdown-toggle">Senarai Ahli</a>
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="anggota.php">Anggota</a></li>
          <li><a class="dropdown-item" href="pemohonpinjaman.php">Pinjaman</a></li>
        </ul>
      </li>

      <li>
        <a class="dropdown-toggle">Transaksi</a>
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="loanrepayment.php">Bulanan</a></li>
          <li><a class="dropdown-item" href="transaction.php">Tidak Tetap</a></li>
        </ul>
      </li>

      <li><a class="nav-link" href="generate.php">Penyata Kewangan</a></li>
      <li><a class="nav-link" href="report.php">Laporan Koperasi</a></li>
