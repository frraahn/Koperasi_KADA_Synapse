...
$sql = "SELECT 
            staffNo, applicantName, photo, applicantIC, applicantPF, applicantStreet, 
            ...
            applicantPhoneHome, applicantSalary, salaryStatement
        FROM applicant 
        WHERE staffNo = ?";
  ...
  <div class="container">
        <div class="content-container">
            ...
            <tr>
             ...
             <tr>
                    <th>Gambar Pemohon</th>
                    <td><a href="data:application/pdf;base64,<?php echo base64_encode($row['salaryStatement']); ?>"download="photo.pdf">Muat Turun Gambar Pemohon </a></td>
                </tr>
            <tr>
            ...
            <tr>
               <th scope="row">Gred</th>
                <td><?php echo htmlspecialchars($row['applicantGrade']); ?></td>
            </tr>
            <tr>
            ...
            <tr>
               <th scope="row">Poskod Pejabat</th>
                <td><?php echo htmlspecialchars($row['officePostcode']); ?></td>
            </tr>
            <tr>
                <th scope="row">Bandar Pejabat</th>
                <td><?php echo htmlspecialchars($row['officeCity']); ?></td>
            </tr>
            <tr>
                <th scope="row">Fax Pejabat</th>
                <td><?php echo htmlspecialchars($row['officeFax']); ?></td>
            </tr>
        </table>
        <a href="reviewMembershipList.php" class="btn btn-secondary mt-3">Kembali</a>
         <a href="adreviewFamily.php?staffNo=<?php echo urlencode($row['staffNo']); ?>" class="btn btn-primary mt-3">Seterusnya : Maklumat Keluarga Pemohon</a>
