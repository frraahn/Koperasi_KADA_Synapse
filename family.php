...
<body>
   <div class="page-header"><h2 class="page-title">PERMOHONAN ANGGOTA</h2></div>
    ...
    <div class="form-container">
            <form method="POST" action="familyprocess.php">
    <!-- Hidden field to track the count -->
    <input type="hidden" id="fCount" name="fCount" value="1">
            <!-- Applicant Information -->
            <div class="form-section-title">MAKLUMAT KELUARGA DAN PEWARIS</div>
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th>HUBUNGAN</th>
                    <th>NAMA</th>
                    <th>NO. K/P @ NO. SURAT BERANAK</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td>1</td>
                    <td><input type="text" name="family[1][relationship]" class="form-control" required></td>
                    <td><input type="text" name="family[1][name]" class="form-control" required></td>
                    <td><input type="text" name="family[1][ic_number]" class="form-control" required></td>
                </tr>
            </tbody>
        </table>
        <a href="#" onclick="addFamilyRow()">Klik di sini untuk menambah bilangan ahli keluarga</a>
    </div>
    ...
    <script>
        function addFamilyRow() {
            ...
            document.getElementById('fCount').value = rowIndex;

            newRow.innerHTML = `
                <td>${rowIndex}</td>
                <td><input type="text" name="family[${rowIndex}][relationship]" class="form-control" required></td>
                <td><input type="text" name="family[${rowIndex}][name]" class="form-control" required></td>
                <td><input type="text" name="family[${rowIndex}][ic_number]" class="form-control" required></td>
            `;
    ...
    <a href="applicant.php" class="btn btn-secondary">KEMBALI</a><!-- Reset the form -->
